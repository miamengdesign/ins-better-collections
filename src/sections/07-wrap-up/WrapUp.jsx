 ...
 * Organized into three ~100vh presentation blocks (intro copy / tools+links /
 * footer) so each screen reads cleanly without accidental blank space between
 * them, while still being ordinary stacked HTML the user scrolls through.
 */
function WrapUp() {
  return (
    <section className={styles.section} aria-label="Wrap up">
      ...
      <div className={`${styles.block} ${styles.footerBlock}`}>
        <img className={styles.bg} src={img('02 Why Collections bg.svg')} alt="" aria-hidden="true" />
